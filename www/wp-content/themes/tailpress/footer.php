...
<section class="py-5 ">
    <div class="container px-0 md:px-5 mx-auto">
        ...
        <!--                    <img src="<?=get_template_directory_uri()?>/images/p7.png" class="block object-cente mx-auto" width="125" height="35" alt="Патнёр">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div class="partners-item w-1/2 sm:w-1/3 md:w-1/4 lg:w-auto relative bg-mlgreen rounded-lg m-2 my-3">-->
        <!--                <div class="flex align-center justify-center rounded h-full py-3">-->
        <!--                    <img src="<?=get_template_directory_uri()?>/images/p6.png" class="block object-center mx-auto" width="125" height="35" alt="Патнёр">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div class="partners-item w-1/2 sm:w-1/3 md:w-1/4 lg:w-auto relative bg-mlgreen rounded-lg m-2 my-3">-->
        <!--                <div class="flex align-center justify-center rounded h-full py-3">-->
        <!--                    <img src="<?=get_template_directory_uri()?>/images/p3.png" class="block object-center mx-auto" width="125" height="35" alt="Патнёр">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div class="partners-item w-1/2 sm:w-1/3 md:w-1/4 lg:w-auto relative bg-mlgreen rounded-lg m-2 my-3">-->
        <!--                <div class="flex align-center justify-center rounded h-full py-3">-->
        <!--                    <img src="<?=get_template_directory_uri()?>/images/p4.png" class="block object-center mx-auto" width="125" height="35" alt="Патнёр">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div class="partners-item w-1/2 sm:w-1/3 md:w-1/4 lg:w-auto relative bg-mlgreen rounded-lg m-2 my-3">-->
        <!--                <div class="flex align-center justify-center rounded h-full py-3">-->
        <!--                    <img src="<?=get_template_directory_uri()?>/images/p5.png" class="block object-center mx-auto" width="125" height="35" alt="Патнёр">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div class="partners-item w-1/2 sm:w-1/3 md:w-1/4 lg:w-auto relative bg-mlgreen rounded-lg m-2 my-3">-->
        <!--                <div class="flex align-center justify-center rounded h-full py-3">-->
        ...
        <!--            <div class="partners-item w-1/2 sm:w-1/3 md:w-1/4 lg:w-auto relative bg-mlgreen rounded-lg m-2 my-3">-->
        <!--                <div class="flex align-center justify-center rounded h-full py-3">-->
        <!--                    <img src="<?=get_template_directory_uri()?>/images/p7.png" class="block object-center mx-auto" width="125" height="35" alt="Патнёр">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--            <div class="partners-item w-1/2 sm:w-1/3 md:w-1/4 lg:w-auto relative bg-mlgreen rounded-lg m-2 my-3">-->
        <!--                <div class="flex align-center justify-center rounded h-full py-3">-->
        <!--                    <img src="<?=get_template_directory_uri()?>/images/p8.png" class="block object-center mx-auto" width="125" height="35" alt="Патнёр">-->
        <!--                </div>-->
        <!--            </div>-->
        <!--        </div>-->
